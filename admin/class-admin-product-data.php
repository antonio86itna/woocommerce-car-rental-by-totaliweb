...
final class WCRBTW_Admin_Product_Data {
    ...
    public function add_rental_tabs( array $tabs ): array {
        ...
        $tabs['rental_details'] = array(
            ...
            'class'    => array( 'show_if_rental_vehicle', 'rental_details_tab' ),
            'priority' => 11,
        );
        ...
        $tabs['rental_rates'] = array(
            ...
            'class'    => array( 'show_if_rental_vehicle', 'rental_rates_tab' ),
            'priority' => 12,
        );
        ...
        $tabs['rental_availability'] = array(
            ...
            'class'    => array( 'show_if_rental_vehicle', 'rental_availability_tab' ),
            'priority' => 13,
        );
        ...
        $tabs['rental_services'] = array(
            ...
            'class'    => array( 'show_if_rental_vehicle', 'rental_services_tab' ),
            'priority' => 14,
        );
        ...
        $tabs['rental_insurance'] = array(
            ...
            'class'    => array( 'show_if_rental_vehicle', 'rental_insurance_tab' ),
            'priority' => 15,
        );
        ...
        $tabs['rental_settings'] = array(
            ...
            'class'    => array( 'show_if_rental_vehicle', 'rental_settings_tab' ),
            'priority' => 16,
        );
    ...
    public function enqueue_admin_scripts( string $hook ): void {
        ...
        wp_enqueue_script(
            ...
            array( 'jquery', 'wc-admin-product-meta-boxes', 'wc-admin-meta-boxes' ),
            WCRBTW_VERSION,
            true
        );
        ...
        // Add inline CSS for immediate tab visibility control
        $custom_css = '
            /* Hide rental tabs by default */
            .product_data_tabs .rental_details_tab,
            .product_data_tabs .rental_rates_tab,
            .product_data_tabs .rental_availability_tab,
            .product_data_tabs .rental_services_tab,
            .product_data_tabs .rental_insurance_tab,
            .product_data_tabs .rental_settings_tab {
                display: none !important;
            }
            
            /* Hide rental panels by default */
            #rental_details_data,
            #rental_rates_data,
            #rental_availability_data,
            #rental_services_data,
            #rental_insurance_data,
            #rental_settings_data {
                display: none;
            }
        ';
